...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(335)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(){
    return ({
        /**
         * @func 常用正则表达式
         */
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = (function(require){
    ...
    var events   = __webpack_require__(336);
    var ext     = __webpack_require__(335);
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(332)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(util){
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(335)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(){
...
var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = (function(require){
    ...
    var loading = __webpack_require__(347);
    var ajax = $.ajax;
...
var _pinyin = __webpack_require__(351);
...
(0, _core.events)({
    ...
    callbacks: {
        project_quick_jump_box: function project_quick_jump_box(data) {
            if (data.value) {
                window.location = data.value;
            }
        }
    },
    getCallback: function getCallback(id) {
    ...
    checkEnable: function checkEnable(id) {
        return ['issue_assigned_', 'values_assigned_', 'values_author_', 'values_watcher_'].find(function (v) {
    ...
    search: function search(e, $elem) {
        ...
        if (!e.target.bind_search && this.checkEnable(id)) {
            ...
            var defaultData = _data.find(function (v) {
                return v.selected;
            }) || _data[0] || {
                name: ''
            };
            var $input = $('<input type="text" value="' + defaultData.name + '" autocomplete="off">');
            var style = this.getStyle(e.target);
            var $wrap = $elem.attr('tabindex', '-1').wrap('<span class="search-wrap"></span>').parent().css(style);
            $input.appendTo($wrap).focus(function () {
                $input.search({
                    nullable: true,
                    cache: true,
                    limit: 10,
                    item: '<li class="con-search-item<%selected($data)%>" data-index="<%$index%>">\n                            <%if $data.label%>\n                            <strong><%$data.label%></strong>\n                            <%else%>\n                            <%$data.name%>\n                            <%/if%>\n                        </li>',
                    ...
                    onSelectBefore: function onSelectBefore(self, data) {
                        if (data.label || data.disabled) {
                            return false;
                        }
                    },
                    onSelect: function onSelect(self, data) {
    ...
    getStyle: function getStyle(elem) {
        ...
        var names = ['maxWidth', 'minWidth', 'width', 'margin'];
        var data = {};
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = (function(require){
    ...
    var component = __webpack_require__(333);
    var util = __webpack_require__(332);
    var request = __webpack_require__(337);
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(348)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(layer){
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__nui__ = __webpack_require__(130);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__template__ = __webpack_require__(334);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util__ = __webpack_require__(332);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__request__ = __webpack_require__(337);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__events__ = __webpack_require__(336);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__component__ = __webpack_require__(333);
